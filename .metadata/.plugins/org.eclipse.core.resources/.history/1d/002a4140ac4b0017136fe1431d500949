var app = angular.module('myApp', [ 'ngRoute','ui.grid','ui.date','ui.bootstrap','ui.bootstrap.demo']);
//
// ,'ui.bootstrap'
...
//											alert('entered the inner function 5:34');
...
app.controller('jsonDataTest', function($scope, $rootScope, $http,uiGridConstants,$interval) {
...
//		  Begin: ui-grid info
		  ...
		  $scope.gridOptions3 = {
				    ...
				    columnDefs: [
				      ...
				      { field: 'email', headerCellClass: $scope.highlightFilteredHeader },
				      { field: 'pmsUid', headerCellClass: $scope.highlightFilteredHeader },
				      { field: 'redID', headerCellClass: $scope.highlightFilteredHeader },
				      { field: 'status', headerCellClass: $scope.highlightFilteredHeader },
				      { field: 'dateReqFrom', headerCellClass: $scope.highlightFilteredHeader },
				      { field: 'dateCompFrom', headerCellClass: $scope.highlightFilteredHeader }
...
//						$http.get('http://localhost:8081/logintest/app/login/getUsers?firstName='+$scope.fName+'&lastName='+$scope.lName+'&em='+$scope.email+'&puid='+$scope.puid+'&reqType='+$scope.rid+'&status='+$scope.status+'&dateReq='+$scope.date_req+'&dateComp='+$scope.date_completed+'')
